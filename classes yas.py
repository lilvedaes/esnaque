...
def Start():
    ...
    while (menu2 == True):
        ...
        #rectangulitos
        pygame.draw.rect(screen, amarillo, pygame.Rect(600, 150, 150, 150))          #botamarillo
        pygame.draw.rect(screen, rosado, pygame.Rect(600, 320, 150, 150))          #botrosado
        pygame.draw.rect(screen, blanco, pygame.Rect(600, 490, 150, 150))        #botblanco
...
def maingame():
    ...
    while not done:
        ...
        #screen.get_at((1100, 600))
        #print(pygame.Surface.get_at((1100,600)))
