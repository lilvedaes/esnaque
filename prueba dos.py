...
#listapalverde = [pax1right, pax1left, pay1down, pay1up]
...
while not done:
    ...
    if pressed[pygame.K_UP]:
        print("up")
        while (pressed[pygame.K_DOWN]==False and pressed[pygame.K_LEFT]== False and pressed[pygame.K_RIGHT]):
        y1 -= 3
    if pressed[pygame.K_DOWN]:
        print("down")
        while (pressed[pygame.K_UP] == False and pressed[pygame.K_LEFT] == False and pressed[pygame.K_RIGHT]):
        y1 += 3
    if pressed[pygame.K_LEFT]:
        print("left")
        while (pressed[pygame.K_DOWN] == False and pressed[pygame.K_UP] == False and pressed[pygame.K_RIGHT]):
        x1 -= 3
    if pressed[pygame.K_RIGHT]:
        print("right")
        while (pressed[pygame.K_DOWN] == False and pressed[pygame.K_LEFT] == False and pressed[pygame.K_UP]):
        x1 += 3
