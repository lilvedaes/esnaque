...
class player:
    ...
    def esnaquegrow(self):
        ...
        for xy in self.body[:-2]:
            ...
            if screen.get_at((self.x +16, self.y +16)) == color1 or screen.get_at((self.x +16, self.y +16)) == color2:
                colision(self)
            ...
            if self.coord in self.body[:-1]:
                colision(self)
                break
            #elif self.coord in other(self).body[:-1]:
             #   colision(self)
              #  break
